...
skip_nacl_sess_update:;
		 ...
		 * (e.g. iSCSI session reinstatement) also get it. Runs for
		 * ha_recv synthetic sessions too -- they carry the real nacl
		 * and are the correct nexus for PR purposes, even though the
		 * nacl_sess/acl_sess_list update above was skipped for them.
		 */
