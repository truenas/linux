...
enum fw_wr_opcodes {
	...
	FW_NVMET_V2_FR_NSMR_TPTE_WR = 0x28,
...
struct fw_nvmet_v2_fr_nsmr_tpte_wr {
	__u8   opcode;
	__u8   v2_flags;
	__u16  wrid;  /* valid only in user-mode */
	__u8   r1[3];
	__u8   len16;
	__be32 r2;
	__be32 stag;
	__be64 cookie;  /* valid only in kernel-mode */
	__be64 r3;
	struct fw_ri_tpte tpte;
#ifndef C99_NOT_SUPPORTED
	__be64 pbl[0];
