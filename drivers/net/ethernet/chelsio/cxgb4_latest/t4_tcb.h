...
#define V_TCB_RX_TLS_FLAGS(x) ((x) << S_TCB_RX_TLS_FLAGS)
...
#define S_T7_TF_BYP_FWD_SACK    11
#define V_T7_TF_BYP_FWD_SACK(x) ((x) << S_T7_TF_BYP_FWD_SACK)

#define S_TF_TX_CHANNEL0    12
#define V_TF_TX_CHANNEL0(x) ((x) << S_TF_TX_CHANNEL0)

#define S_T7_TF_CHANNEL    12
#define M_T7_TF_CHANNEL    0x3ULL
#define V_T7_TF_CHANNEL(x) ((x) << S_T7_TF_CHANNEL)

#define S_T7_TF_LPBK_CHANNEL    12
#define M_T7_TF_LPBK_CHANNEL    0x3ULL
#define V_T7_TF_LPBK_CHANNEL(x) ((x) << S_T7_TF_LPBK_CHANNEL)
