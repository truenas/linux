...
/* Generation Date : Thu Jan 19 22:54:31 IST 2023 */
/* Directory name: t4_reg.txt, Date: Not specified */
/* Directory name: t5_reg.txt, Changeset: 6941:9063655afd44 */
/* Directory name: t6_reg.txt, Changeset: 4273:a09f2156fbaf */
/* Directory name: t7_reg.txt, Changeset: 4582:4ad25421d47a */
...
#define NUM_MC_P_BIST_USER_INSTANCES 32

#define MC_D5ACSM0_DWC_DDRPHY_TOP_D5ACSM0(idx) (A_MC_D5ACSM0_DWC_DDRPHY_TOP_D5ACSM0 + (idx) * 2)
#define NUM_MC_D5ACSM0_DWC_DDRPHY_TOP_D5ACSM0_INSTANCES 512

#define MC_D5ACSM1_DWC_DDRPHY_TOP_D5ACSM1(idx) (A_MC_D5ACSM1_DWC_DDRPHY_TOP_D5ACSM1 + (idx) * 2)
#define NUM_MC_D5ACSM1_DWC_DDRPHY_TOP_D5ACSM1_INSTANCES 512

#define MC_ICCM_DWC_DDRPHY_TOP_ICCM(idx) (A_MC_ICCM_DWC_DDRPHY_TOP_ICCM + (idx) * 2)
#define NUM_MC_ICCM_DWC_DDRPHY_TOP_ICCM_INSTANCES 16384

#define MC_DCCM_DWC_DDRPHY_TOP_DCCM(idx) (A_MC_DCCM_DWC_DDRPHY_TOP_DCCM + (idx) * 2)
#define NUM_MC_DCCM_DWC_DDRPHY_TOP_DCCM_INSTANCES 16384
...
#define S_T7_SIZE    4
#define M_T7_SIZE    0xfffffU
#define V_T7_SIZE(x) ((x) << S_T7_SIZE)
#define G_T7_SIZE(x) (((x) >> S_T7_SIZE) & M_T7_SIZE)
...
#define S_T7_EGRTHRESHOLDPACKING    16
#define M_T7_EGRTHRESHOLDPACKING    0xffU
#define V_T7_EGRTHRESHOLDPACKING(x) ((x) << S_T7_EGRTHRESHOLDPACKING)
#define G_T7_EGRTHRESHOLDPACKING(x) (((x) >> S_T7_EGRTHRESHOLDPACKING) & M_T7_EGRTHRESHOLDPACKING)

#define S_T7_EGRTHRESHOLD    8
#define M_T7_EGRTHRESHOLD    0xffU
#define V_T7_EGRTHRESHOLD(x) ((x) << S_T7_EGRTHRESHOLD)
#define G_T7_EGRTHRESHOLD(x) (((x) >> S_T7_EGRTHRESHOLD) & M_T7_EGRTHRESHOLD)
...
#define S_T7_DROP_TIMEOUT    7
#define M_T7_DROP_TIMEOUT    0x3fU
#define V_T7_DROP_TIMEOUT(x) ((x) << S_T7_DROP_TIMEOUT)
#define G_T7_DROP_TIMEOUT(x) (((x) >> S_T7_DROP_TIMEOUT) & M_T7_DROP_TIMEOUT)
...
#define S_T7_STATMODE    0
#define M_T7_STATMODE    0xfU
#define V_T7_STATMODE(x) ((x) << S_T7_STATMODE)
#define G_T7_STATMODE(x) (((x) >> S_T7_STATMODE) & M_T7_STATMODE)
...
#define S_T7_DBVFIFO_SIZE    0
#define M_T7_DBVFIFO_SIZE    0x1fffU
#define V_T7_DBVFIFO_SIZE(x) ((x) << S_T7_DBVFIFO_SIZE)
#define G_T7_DBVFIFO_SIZE(x) (((x) >> S_T7_DBVFIFO_SIZE) & M_T7_DBVFIFO_SIZE)
...
#define S_DEBUG_FLM_IDMA3_CACHE_DATA_ACTIVE    24
#define V_DEBUG_FLM_IDMA3_CACHE_DATA_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA3_CACHE_DATA_ACTIVE)
#define F_DEBUG_FLM_IDMA3_CACHE_DATA_ACTIVE    V_DEBUG_FLM_IDMA3_CACHE_DATA_ACTIVE(1U)

#define S_DEBUG_FLM_IDMA3_CACHE_HDR_ACTIVE    23
#define V_DEBUG_FLM_IDMA3_CACHE_HDR_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA3_CACHE_HDR_ACTIVE)
#define F_DEBUG_FLM_IDMA3_CACHE_HDR_ACTIVE    V_DEBUG_FLM_IDMA3_CACHE_HDR_ACTIVE(1U)

#define S_DEBUG_FLM_IDMA3_CTXT_DATA_ACTIVE    22
#define V_DEBUG_FLM_IDMA3_CTXT_DATA_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA3_CTXT_DATA_ACTIVE)
#define F_DEBUG_FLM_IDMA3_CTXT_DATA_ACTIVE    V_DEBUG_FLM_IDMA3_CTXT_DATA_ACTIVE(1U)

#define S_DEBUG_FLM_IDMA3_CTXT_HDR_ACTIVE    21
#define V_DEBUG_FLM_IDMA3_CTXT_HDR_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA3_CTXT_HDR_ACTIVE)
#define F_DEBUG_FLM_IDMA3_CTXT_HDR_ACTIVE    V_DEBUG_FLM_IDMA3_CTXT_HDR_ACTIVE(1U)

#define S_DEBUG_ST_FLM_IDMA3_CACHE    19
#define M_DEBUG_ST_FLM_IDMA3_CACHE    0x3U
#define V_DEBUG_ST_FLM_IDMA3_CACHE(x) ((x) << S_DEBUG_ST_FLM_IDMA3_CACHE)
#define G_DEBUG_ST_FLM_IDMA3_CACHE(x) (((x) >> S_DEBUG_ST_FLM_IDMA3_CACHE) & M_DEBUG_ST_FLM_IDMA3_CACHE)

#define S_DEBUG_ST_FLM_IDMA3_CTXT    16
#define M_DEBUG_ST_FLM_IDMA3_CTXT    0x7U
#define V_DEBUG_ST_FLM_IDMA3_CTXT(x) ((x) << S_DEBUG_ST_FLM_IDMA3_CTXT)
#define G_DEBUG_ST_FLM_IDMA3_CTXT(x) (((x) >> S_DEBUG_ST_FLM_IDMA3_CTXT) & M_DEBUG_ST_FLM_IDMA3_CTXT)

#define S_DEBUG_FLM_IDMA2_CACHE_DATA_ACTIVE    8
#define V_DEBUG_FLM_IDMA2_CACHE_DATA_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA2_CACHE_DATA_ACTIVE)
#define F_DEBUG_FLM_IDMA2_CACHE_DATA_ACTIVE    V_DEBUG_FLM_IDMA2_CACHE_DATA_ACTIVE(1U)

#define S_DEBUG_FLM_IDMA2_CACHE_HDR_ACTIVE    7
#define V_DEBUG_FLM_IDMA2_CACHE_HDR_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA2_CACHE_HDR_ACTIVE)
#define F_DEBUG_FLM_IDMA2_CACHE_HDR_ACTIVE    V_DEBUG_FLM_IDMA2_CACHE_HDR_ACTIVE(1U)

#define S_DEBUG_FLM_IDMA2_CTXT_DATA_ACTIVE    6
#define V_DEBUG_FLM_IDMA2_CTXT_DATA_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA2_CTXT_DATA_ACTIVE)
#define F_DEBUG_FLM_IDMA2_CTXT_DATA_ACTIVE    V_DEBUG_FLM_IDMA2_CTXT_DATA_ACTIVE(1U)

#define S_DEBUG_FLM_IDMA2_CTXT_HDR_ACTIVE    5
#define V_DEBUG_FLM_IDMA2_CTXT_HDR_ACTIVE(x) ((x) << S_DEBUG_FLM_IDMA2_CTXT_HDR_ACTIVE)
#define F_DEBUG_FLM_IDMA2_CTXT_HDR_ACTIVE    V_DEBUG_FLM_IDMA2_CTXT_HDR_ACTIVE(1U)

#define S_DEBUG_ST_FLM_IDMA2_CACHE    3
#define M_DEBUG_ST_FLM_IDMA2_CACHE    0x3U
#define V_DEBUG_ST_FLM_IDMA2_CACHE(x) ((x) << S_DEBUG_ST_FLM_IDMA2_CACHE)
#define G_DEBUG_ST_FLM_IDMA2_CACHE(x) (((x) >> S_DEBUG_ST_FLM_IDMA2_CACHE) & M_DEBUG_ST_FLM_IDMA2_CACHE)

#define S_DEBUG_ST_FLM_IDMA2_CTXT    0
#define M_DEBUG_ST_FLM_IDMA2_CTXT    0x7U
#define V_DEBUG_ST_FLM_IDMA2_CTXT(x) ((x) << S_DEBUG_ST_FLM_IDMA2_CTXT)
#define G_DEBUG_ST_FLM_IDMA2_CTXT(x) (((x) >> S_DEBUG_ST_FLM_IDMA2_CTXT) & M_DEBUG_ST_FLM_IDMA2_CTXT)
...
#define S_T7_DEBUG_CIM2SGE_RXAFULL_D    25
#define M_T7_DEBUG_CIM2SGE_RXAFULL_D    0xfU
#define V_T7_DEBUG_CIM2SGE_RXAFULL_D(x) ((x) << S_T7_DEBUG_CIM2SGE_RXAFULL_D)
#define G_T7_DEBUG_CIM2SGE_RXAFULL_D(x) (((x) >> S_T7_DEBUG_CIM2SGE_RXAFULL_D) & M_T7_DEBUG_CIM2SGE_RXAFULL_D)
...
#define S_T7_DEBUG_CPLSW_CIM_TXAFULL_D    12
#define M_T7_DEBUG_CPLSW_CIM_TXAFULL_D    0xfU
#define V_T7_DEBUG_CPLSW_CIM_TXAFULL_D(x) ((x) << S_T7_DEBUG_CPLSW_CIM_TXAFULL_D)
#define G_T7_DEBUG_CPLSW_CIM_TXAFULL_D(x) (((x) >> S_T7_DEBUG_CPLSW_CIM_TXAFULL_D) & M_T7_DEBUG_CPLSW_CIM_TXAFULL_D)

#define S_T7_DEBUG_T_RXAFULL_D    8
#define M_T7_DEBUG_T_RXAFULL_D    0xfU
#define V_T7_DEBUG_T_RXAFULL_D(x) ((x) << S_T7_DEBUG_T_RXAFULL_D)
#define G_T7_DEBUG_T_RXAFULL_D(x) (((x) >> S_T7_DEBUG_T_RXAFULL_D) & M_T7_DEBUG_T_RXAFULL_D)
...
#define S_T7_DEBUG_PD_WRREQAFULL_D    6
#define M_T7_DEBUG_PD_WRREQAFULL_D    0xfU
#define V_T7_DEBUG_PD_WRREQAFULL_D(x) ((x) << S_T7_DEBUG_PD_WRREQAFULL_D)
#define G_T7_DEBUG_PD_WRREQAFULL_D(x) (((x) >> S_T7_DEBUG_PD_WRREQAFULL_D) & M_T7_DEBUG_PD_WRREQAFULL_D)

#define S_T7_DEBUG_PC_RSPAFULL_D    5
#define V_T7_DEBUG_PC_RSPAFULL_D(x) ((x) << S_T7_DEBUG_PC_RSPAFULL_D)
#define F_T7_DEBUG_PC_RSPAFULL_D    V_T7_DEBUG_PC_RSPAFULL_D(1U)

#define S_T7_DEBUG_PC_REQAFULL_D    4
#define V_T7_DEBUG_PC_REQAFULL_D(x) ((x) << S_T7_DEBUG_PC_REQAFULL_D)
#define F_T7_DEBUG_PC_REQAFULL_D    V_T7_DEBUG_PC_REQAFULL_D(1U)

#define S_T7_DEBUG_U_RXAFULL_D    0
#define M_T7_DEBUG_U_RXAFULL_D    0xfU
#define V_T7_DEBUG_U_RXAFULL_D(x) ((x) << S_T7_DEBUG_U_RXAFULL_D)
#define G_T7_DEBUG_U_RXAFULL_D(x) (((x) >> S_T7_DEBUG_U_RXAFULL_D) & M_T7_DEBUG_U_RXAFULL_D)
...
#define S_T7_DEBUG_CIM_AFULL_D    12
#define M_T7_DEBUG_CIM_AFULL_D    0xfU
#define V_T7_DEBUG_CIM_AFULL_D(x) ((x) << S_T7_DEBUG_CIM_AFULL_D)
#define G_T7_DEBUG_CIM_AFULL_D(x) (((x) >> S_T7_DEBUG_CIM_AFULL_D) & M_T7_DEBUG_CIM_AFULL_D)
...
#define S_T7_DEBUG_ST_DBP_UPCP_MAIN    14
#define M_T7_DEBUG_ST_DBP_UPCP_MAIN    0x7U
#define V_T7_DEBUG_ST_DBP_UPCP_MAIN(x) ((x) << S_T7_DEBUG_ST_DBP_UPCP_MAIN)
#define G_T7_DEBUG_ST_DBP_UPCP_MAIN(x) (((x) >> S_T7_DEBUG_ST_DBP_UPCP_MAIN) & M_T7_DEBUG_ST_DBP_UPCP_MAIN)
...
#define S_T7_ENABLE    31
#define V_T7_ENABLE(x) ((x) << S_T7_ENABLE)
#define F_T7_ENABLE    V_T7_ENABLE(1U)

#define S_T7_AI    30
#define V_T7_AI(x) ((x) << S_T7_AI)
#define F_T7_AI    V_T7_AI(1U)

#define S_T7_CS2    29
#define V_T7_CS2(x) ((x) << S_T7_CS2)
#define F_T7_CS2    V_T7_CS2(1U)

#define S_T7_WRBE    25
#define M_T7_WRBE    0xfU
#define V_T7_WRBE(x) ((x) << S_T7_WRBE)
#define G_T7_WRBE(x) (((x) >> S_T7_WRBE) & M_T7_WRBE)

#define S_T7_CFG_SPACE_VFVLD    24
#define V_T7_CFG_SPACE_VFVLD(x) ((x) << S_T7_CFG_SPACE_VFVLD)
#define F_T7_CFG_SPACE_VFVLD    V_T7_CFG_SPACE_VFVLD(1U)

#define S_T7_CFG_SPACE_RVF    16
#define M_T7_CFG_SPACE_RVF    0xffU
#define V_T7_CFG_SPACE_RVF(x) ((x) << S_T7_CFG_SPACE_RVF)
#define G_T7_CFG_SPACE_RVF(x) (((x) >> S_T7_CFG_SPACE_RVF) & M_T7_CFG_SPACE_RVF)
...
#define S_T7_PDEBUGSELH    16
#define M_T7_PDEBUGSELH    0x7fU
#define V_T7_PDEBUGSELH(x) ((x) << S_T7_PDEBUGSELH)
#define G_T7_PDEBUGSELH(x) (((x) >> S_T7_PDEBUGSELH) & M_T7_PDEBUGSELH)

#define S_T7_PDEBUGSELL    0
#define M_T7_PDEBUGSELL    0x7fU
#define V_T7_PDEBUGSELL(x) ((x) << S_T7_PDEBUGSELL)
#define G_T7_PDEBUGSELL(x) (((x) >> S_T7_PDEBUGSELL) & M_T7_PDEBUGSELL)
...
#define S_T7_SYNSHIFTMAX    24
#define M_T7_SYNSHIFTMAX    0xfU
#define V_T7_SYNSHIFTMAX(x) ((x) << S_T7_SYNSHIFTMAX)
#define G_T7_SYNSHIFTMAX(x) (((x) >> S_T7_SYNSHIFTMAX) & M_T7_SYNSHIFTMAX)
...
#define S_T7_CHNENABLE    29
#define V_T7_CHNENABLE(x) ((x) << S_T7_CHNENABLE)
#define F_T7_CHNENABLE    V_T7_CHNENABLE(1U)
...
#define S_ENC_LEN_2X    14
#define V_ENC_LEN_2X(x) ((x) << S_ENC_LEN_2X)
#define F_ENC_LEN_2X    V_ENC_LEN_2X(1U)
...
#define A_TP_ESIDE_DEBUG_CFG 0x168
...
#define S_SGE_FIFO_PAR_ERR3    11
#define V_SGE_FIFO_PAR_ERR3(x) ((x) << S_SGE_FIFO_PAR_ERR3)
#define F_SGE_FIFO_PAR_ERR3    V_SGE_FIFO_PAR_ERR3(1U)

#define S_SGE_FIFO_PAR_ERR2    10
#define V_SGE_FIFO_PAR_ERR2(x) ((x) << S_SGE_FIFO_PAR_ERR2)
#define F_SGE_FIFO_PAR_ERR2    V_SGE_FIFO_PAR_ERR2(1U)

#define S_SGE_FIFO_PAR_ERR1    9
#define V_SGE_FIFO_PAR_ERR1(x) ((x) << S_SGE_FIFO_PAR_ERR1)
#define F_SGE_FIFO_PAR_ERR1    V_SGE_FIFO_PAR_ERR1(1U)

#define S_SGE_FIFO_PAR_ERR0    8
#define V_SGE_FIFO_PAR_ERR0(x) ((x) << S_SGE_FIFO_PAR_ERR0)
#define F_SGE_FIFO_PAR_ERR0    V_SGE_FIFO_PAR_ERR0(1U)
...
#define S_T7_MC_WCNT_FIFO_PERR    27
#define V_T7_MC_WCNT_FIFO_PERR(x) ((x) << S_T7_MC_WCNT_FIFO_PERR)
#define F_T7_MC_WCNT_FIFO_PERR    V_T7_MC_WCNT_FIFO_PERR(1U)

#define S_T7_MC_WDATA_FIFO_PERR    26
#define V_T7_MC_WDATA_FIFO_PERR(x) ((x) << S_T7_MC_WDATA_FIFO_PERR)
#define F_T7_MC_WDATA_FIFO_PERR    V_T7_MC_WDATA_FIFO_PERR(1U)

#define S_T7_MC_RCNT_FIFO_PERR    25
#define V_T7_MC_RCNT_FIFO_PERR(x) ((x) << S_T7_MC_RCNT_FIFO_PERR)
#define F_T7_MC_RCNT_FIFO_PERR    V_T7_MC_RCNT_FIFO_PERR(1U)

#define S_T7_MC_RDATA_FIFO_PERR    24
#define V_T7_MC_RDATA_FIFO_PERR(x) ((x) << S_T7_MC_RDATA_FIFO_PERR)
#define F_T7_MC_RDATA_FIFO_PERR    V_T7_MC_RDATA_FIFO_PERR(1U)

#define S_T7_ICSPI0_FIFO2X_RX_FRAMING_ERROR    23
...
#define S_T7_ICSPI1_FIFO2X_RX_FRAMING_ERROR    22
...
#define S_T7_ICSPI2_FIFO2X_RX_FRAMING_ERROR    21
...
#define S_T7_ICSPI3_FIFO2X_RX_FRAMING_ERROR    20
...
#define S_T7_VALID    21
#define V_T7_VALID(x) ((x) << S_T7_VALID)
#define F_T7_VALID    V_T7_VALID(1U)

#define S_T7_HASHPORTMAP    17
#define M_T7_HASHPORTMAP    0xfU
#define V_T7_HASHPORTMAP(x) ((x) << S_T7_HASHPORTMAP)
#define G_T7_HASHPORTMAP(x) (((x) >> S_T7_HASHPORTMAP) & M_T7_HASHPORTMAP)

#define S_T7_MULTILISTEN    16
#define V_T7_MULTILISTEN(x) ((x) << S_T7_MULTILISTEN)
#define F_T7_MULTILISTEN    V_T7_MULTILISTEN(1U)

#define S_T7_PRIORITY    13
#define M_T7_PRIORITY    0x7U
#define V_T7_PRIORITY(x) ((x) << S_T7_PRIORITY)
#define G_T7_PRIORITY(x) (((x) >> S_T7_PRIORITY) & M_T7_PRIORITY)

#define S_T7_REPLICATE    12
#define V_T7_REPLICATE(x) ((x) << S_T7_REPLICATE)
#define F_T7_REPLICATE    V_T7_REPLICATE(1U)

#define S_T7_PF    9
#define M_T7_PF    0x7U
#define V_T7_PF(x) ((x) << S_T7_PF)
#define G_T7_PF(x) (((x) >> S_T7_PF) & M_T7_PF)

#define S_T7_VF_VALID    8
#define V_T7_VF_VALID(x) ((x) << S_T7_VF_VALID)
#define F_T7_VF_VALID    V_T7_VF_VALID(1U)

#define S_T7_VF    0
#define M_T7_VF    0xffU
#define V_T7_VF(x) ((x) << S_T7_VF)
#define G_T7_VF(x) (((x) >> S_T7_VF) & M_T7_VF)
...
#define S_T7_DISENCAPOUTERRPLCT    31
#define V_T7_DISENCAPOUTERRPLCT(x) ((x) << S_T7_DISENCAPOUTERRPLCT)
#define F_T7_DISENCAPOUTERRPLCT    V_T7_DISENCAPOUTERRPLCT(1U)

#define S_T7_DISENCAP    30
#define V_T7_DISENCAP(x) ((x) << S_T7_DISENCAP)
#define F_T7_DISENCAP    V_T7_DISENCAP(1U)

#define S_T7_MULTILISTEN3    29
#define V_T7_MULTILISTEN3(x) ((x) << S_T7_MULTILISTEN3)
#define F_T7_MULTILISTEN3    V_T7_MULTILISTEN3(1U)

#define S_T7_MULTILISTEN2    28
#define V_T7_MULTILISTEN2(x) ((x) << S_T7_MULTILISTEN2)
#define F_T7_MULTILISTEN2    V_T7_MULTILISTEN2(1U)

#define S_T7_MULTILISTEN1    27
#define V_T7_MULTILISTEN1(x) ((x) << S_T7_MULTILISTEN1)
#define F_T7_MULTILISTEN1    V_T7_MULTILISTEN1(1U)

#define S_T7_MULTILISTEN0    26
#define V_T7_MULTILISTEN0(x) ((x) << S_T7_MULTILISTEN0)
#define F_T7_MULTILISTEN0    V_T7_MULTILISTEN0(1U)

#define S_T7_SRAM_PRIO3    23
#define M_T7_SRAM_PRIO3    0x7U
#define V_T7_SRAM_PRIO3(x) ((x) << S_T7_SRAM_PRIO3)
#define G_T7_SRAM_PRIO3(x) (((x) >> S_T7_SRAM_PRIO3) & M_T7_SRAM_PRIO3)

#define S_T7_SRAM_PRIO2    20
#define M_T7_SRAM_PRIO2    0x7U
#define V_T7_SRAM_PRIO2(x) ((x) << S_T7_SRAM_PRIO2)
#define G_T7_SRAM_PRIO2(x) (((x) >> S_T7_SRAM_PRIO2) & M_T7_SRAM_PRIO2)

#define S_T7_SRAM_PRIO1    17
#define M_T7_SRAM_PRIO1    0x7U
#define V_T7_SRAM_PRIO1(x) ((x) << S_T7_SRAM_PRIO1)
#define G_T7_SRAM_PRIO1(x) (((x) >> S_T7_SRAM_PRIO1) & M_T7_SRAM_PRIO1)

#define S_T7_SRAM_PRIO0    14
#define M_T7_SRAM_PRIO0    0x7U
#define V_T7_SRAM_PRIO0(x) ((x) << S_T7_SRAM_PRIO0)
#define G_T7_SRAM_PRIO0(x) (((x) >> S_T7_SRAM_PRIO0) & M_T7_SRAM_PRIO0)

#define S_T7_SRAM_VLD    13
#define V_T7_SRAM_VLD(x) ((x) << S_T7_SRAM_VLD)
#define F_T7_SRAM_VLD    V_T7_SRAM_VLD(1U)
...
#define A_MPS_T7B_CLS_SRAM_H 0xe004
...
#define S_T7_ATRB    17
#define V_T7_ATRB(x) ((x) << S_T7_ATRB)
#define F_T7_ATRB    V_T7_ATRB(1U)

#define S_T7_RPLC    12
#define M_T7_RPLC    0x1fU
#define V_T7_RPLC(x) ((x) << S_T7_RPLC)
#define G_T7_RPLC(x) (((x) >> S_T7_RPLC) & M_T7_RPLC)
...
#define S_ENABLE_FF    14
#define V_ENABLE_FF(x) ((x) << S_ENABLE_FF)
#define F_ENABLE_FF    V_ENABLE_FF(1U)

#define S_ENABLE_ULPRX2SBT_INTFPERR    13
#define V_ENABLE_ULPRX2SBT_INTFPERR(x) ((x) << S_ENABLE_ULPRX2SBT_INTFPERR)
#define F_ENABLE_ULPRX2SBT_INTFPERR    V_ENABLE_ULPRX2SBT_INTFPERR(1U)

#define S_ENABLE_ULPRX2MA_INTFPERR    12
...
#define S_T7_SOURCEPF    9
#define M_T7_SOURCEPF    0x7U
#define V_T7_SOURCEPF(x) ((x) << S_T7_SOURCEPF)
#define G_T7_SOURCEPF(x) (((x) >> S_T7_SOURCEPF) & M_T7_SOURCEPF)

#define S_T7_ISVF    8
#define V_T7_ISVF(x) ((x) << S_T7_ISVF)
#define F_T7_ISVF    V_T7_ISVF(1U)

#define S_T7_VFID    0
#define M_T7_VFID    0xffU
#define V_T7_VFID(x) ((x) << S_T7_VFID)
#define G_T7_VFID(x) (((x) >> S_T7_VFID) & M_T7_VFID)
...
#define S_T7_PL_TOVFID    0
#define M_T7_PL_TOVFID    0x1ffU
#define V_T7_PL_TOVFID(x) ((x) << S_T7_PL_TOVFID)
#define G_T7_PL_TOVFID(x) (((x) >> S_T7_PL_TOVFID) & M_T7_PL_TOVFID)
...
#define S_T7_SRINDX    0
#define M_T7_SRINDX    0xfffffU
#define V_T7_SRINDX(x) ((x) << S_T7_SRINDX)
#define G_T7_SRINDX(x) (((x) >> S_T7_SRINDX) & M_T7_SRINDX)
...
#define S_T7_ACTRGNFULL    21
#define V_T7_ACTRGNFULL(x) ((x) << S_T7_ACTRGNFULL)
#define F_T7_ACTRGNFULL    V_T7_ACTRGNFULL(1U)

#define S_T7_ACTCNTIPV6TZERO    20
#define V_T7_ACTCNTIPV6TZERO(x) ((x) << S_T7_ACTCNTIPV6TZERO)
#define F_T7_ACTCNTIPV6TZERO    V_T7_ACTCNTIPV6TZERO(1U)

#define S_T7_ACTCNTIPV4TZERO    19
#define V_T7_ACTCNTIPV4TZERO(x) ((x) << S_T7_ACTCNTIPV4TZERO)
#define F_T7_ACTCNTIPV4TZERO    V_T7_ACTCNTIPV4TZERO(1U)

#define S_T7_ACTCNTIPV6ZERO    18
#define V_T7_ACTCNTIPV6ZERO(x) ((x) << S_T7_ACTCNTIPV6ZERO)
#define F_T7_ACTCNTIPV6ZERO    V_T7_ACTCNTIPV6ZERO(1U)

#define S_T7_ACTCNTIPV4ZERO    17
#define V_T7_ACTCNTIPV4ZERO(x) ((x) << S_T7_ACTCNTIPV4ZERO)
#define F_T7_ACTCNTIPV4ZERO    V_T7_ACTCNTIPV4ZERO(1U)

#define S_T7_UNKNOWNCMD    3
#define V_T7_UNKNOWNCMD(x) ((x) << S_T7_UNKNOWNCMD)
#define F_T7_UNKNOWNCMD    V_T7_UNKNOWNCMD(1U)

#define S_T7_LIP0    2
#define V_T7_LIP0(x) ((x) << S_T7_LIP0)
#define F_T7_LIP0    V_T7_LIP0(1U)

#define S_T7_LIPMISS    1
#define V_T7_LIPMISS(x) ((x) << S_T7_LIPMISS)
#define F_T7_LIPMISS    V_T7_LIPMISS(1U)
...
#define S_T7_MISS    20
#define M_T7_MISS    0x1fU
#define V_T7_MISS(x) ((x) << S_T7_MISS)
#define G_T7_MISS(x) (((x) >> S_T7_MISS) & M_T7_MISS)
...
#define S_T7_CLCAMFIFOERR    2
#define V_T7_CLCAMFIFOERR(x) ((x) << S_T7_CLCAMFIFOERR)
#define F_T7_CLCAMFIFOERR    V_T7_CLCAMFIFOERR(1U)

#define S_T7_HASHTBLMEMCRCERR    1
#define V_T7_HASHTBLMEMCRCERR(x) ((x) << S_T7_HASHTBLMEMCRCERR)
#define F_T7_HASHTBLMEMCRCERR    V_T7_HASHTBLMEMCRCERR(1U)
...
#define S_T7_PERR_PKT_RAM    31
#define V_T7_PERR_PKT_RAM(x) ((x) << S_T7_PERR_PKT_RAM)
#define F_T7_PERR_PKT_RAM    V_T7_PERR_PKT_RAM(1U)

#define S_T7_PERR_MASK_RAM    30
#define V_T7_PERR_MASK_RAM(x) ((x) << S_T7_PERR_MASK_RAM)
#define F_T7_PERR_MASK_RAM    V_T7_PERR_MASK_RAM(1U)

#define S_T7_PERR_CRC_RAM    29
#define V_T7_PERR_CRC_RAM(x) ((x) << S_T7_PERR_CRC_RAM)
#define F_T7_PERR_CRC_RAM    V_T7_PERR_CRC_RAM(1U)
...
#define A_MAC_HSS0_TXS0_ANA_OVRDVAL2 0x3a058
#define A_MAC_HSS0_TXS0_ANA_OVRDVAL3 0x3a05c
#define A_MAC_HSS0_TXS1_ANA_OVRDVAL2 0x3a158
#define A_MAC_HSS0_TXS1_ANA_OVRDVAL3 0x3a15c
#define A_MAC_HSS0_CMS_CFG 0x3a600
#define A_MAC_HSS0_CMS_OVRDEN 0x3a604
#define A_MAC_HSS0_CMS_OVRDVAL 0x3a608
#define A_MAC_HSS0_CMS_STAT 0x3a60c
#define A_MAC_HSS0_PLLO_DIV_CFG2 0x3a624
#define A_MAC_HSS0_PLLO_DIV_CFG3 0x3a628
#define A_MAC_HSS0_PLLO_SSC_CFG0 0x3a62c
#define A_MAC_HSS0_PLLO_SSC_CFG1 0x3a630
#define A_MAC_HSS0_PLLO_SSC_CFG2 0x3a634
#define A_MAC_HSS0_PLLO_SSC_CFG3 0x3a638
#define A_MAC_HSS0_PLL1_DIV_CFG2 0x3a65c
#define A_MAC_HSS0_PLL1_DIV_CFG3 0x3a660
#define A_MAC_HSS0_PLL1_SSC_CFG0 0x3a664
#define A_MAC_HSS0_PLL1_SSC_CFG1 0x3a668
#define A_MAC_HSS0_PLL1_SSC_CFG2 0x3a66c
#define A_MAC_HSS0_PLL1_SSC_CFG3 0x3a670
#define A_MAC_HSS0_AN_CFG2 0x3a73c
#define A_MAC_HSS0_CTRL_FSM_CFG35 0x3a7cc
#define A_MAC_HSS0_CTRL_FSM_CFG36 0x3a7d0
#define A_MAC_HSS1_TXS0_ANA_OVRDVAL2 0x3b058
#define A_MAC_HSS1_TXS0_ANA_OVRDVAL3 0x3b05c
#define A_MAC_HSS1_TXS1_ANA_OVRDVAL2 0x3b158
#define A_MAC_HSS1_TXS1_ANA_OVRDVAL3 0x3b15c
#define A_MAC_HSS1_CMS_CFG 0x3b600
#define A_MAC_HSS1_CMS_OVRDEN 0x3b604
#define A_MAC_HSS1_CMS_OVRDVAL 0x3b608
#define A_MAC_HSS1_CMS_STAT 0x3b60c
#define A_MAC_HSS1_PLLO_DIV_CFG2 0x3b624
#define A_MAC_HSS1_PLLO_DIV_CFG3 0x3b628
#define A_MAC_HSS1_PLLO_SSC_CFG0 0x3b62c
#define A_MAC_HSS1_PLLO_SSC_CFG1 0x3b630
#define A_MAC_HSS1_PLLO_SSC_CFG2 0x3b634
#define A_MAC_HSS1_PLLO_SSC_CFG3 0x3b638
#define A_MAC_HSS1_PLL1_DIV_CFG2 0x3b65c
#define A_MAC_HSS1_PLL1_DIV_CFG3 0x3b660
#define A_MAC_HSS1_PLL1_SSC_CFG0 0x3b664
#define A_MAC_HSS1_PLL1_SSC_CFG1 0x3b668
#define A_MAC_HSS1_PLL1_SSC_CFG2 0x3b66c
#define A_MAC_HSS1_PLL1_SSC_CFG3 0x3b670
#define A_MAC_HSS1_AN_CFG2 0x3b73c
#define A_MAC_HSS1_CTRL_FSM_CFG35 0x3b7cc
#define A_MAC_HSS1_CTRL_FSM_CFG36 0x3b7d0
#define A_MAC_HSS2_TXS0_ANA_OVRDVAL2 0x3c058
#define A_MAC_HSS2_TXS0_ANA_OVRDVAL3 0x3c05c
#define A_MAC_HSS2_TXS1_ANA_OVRDVAL2 0x3c158
#define A_MAC_HSS2_TXS1_ANA_OVRDVAL3 0x3c15c
#define A_MAC_HSS2_CMS_CFG 0x3c600
#define A_MAC_HSS2_CMS_OVRDEN 0x3c604
#define A_MAC_HSS2_CMS_OVRDVAL 0x3c608
#define A_MAC_HSS2_CMS_STAT 0x3c60c
#define A_MAC_HSS2_PLLO_DIV_CFG2 0x3c624
#define A_MAC_HSS2_PLLO_DIV_CFG3 0x3c628
#define A_MAC_HSS2_PLLO_SSC_CFG0 0x3c62c
#define A_MAC_HSS2_PLLO_SSC_CFG1 0x3c630
#define A_MAC_HSS2_PLLO_SSC_CFG2 0x3c634
#define A_MAC_HSS2_PLLO_SSC_CFG3 0x3c638
#define A_MAC_HSS2_PLL1_DIV_CFG2 0x3c65c
#define A_MAC_HSS2_PLL1_DIV_CFG3 0x3c660
#define A_MAC_HSS2_PLL1_SSC_CFG0 0x3c664
#define A_MAC_HSS2_PLL1_SSC_CFG1 0x3c668
#define A_MAC_HSS2_PLL1_SSC_CFG2 0x3c66c
#define A_MAC_HSS2_PLL1_SSC_CFG3 0x3c670
#define A_MAC_HSS2_AN_CFG2 0x3c73c
#define A_MAC_HSS2_CTRL_FSM_CFG35 0x3c7cc
#define A_MAC_HSS2_CTRL_FSM_CFG36 0x3c7d0
#define A_MAC_HSS3_TXS0_ANA_OVRDVAL2 0x3d058
#define A_MAC_HSS3_TXS0_ANA_OVRDVAL3 0x3d05c
#define A_MAC_HSS3_TXS1_ANA_OVRDVAL2 0x3d158
#define A_MAC_HSS3_TXS1_ANA_OVRDVAL3 0x3d15c
#define A_MAC_HSS3_CMS_CFG 0x3d600
#define A_MAC_HSS3_CMS_OVRDEN 0x3d604
#define A_MAC_HSS3_CMS_OVRDVAL 0x3d608
#define A_MAC_HSS3_CMS_STAT 0x3d60c
#define A_MAC_HSS3_PLLO_DIV_CFG2 0x3d624
#define A_MAC_HSS3_PLLO_DIV_CFG3 0x3d628
#define A_MAC_HSS3_PLLO_SSC_CFG0 0x3d62c
#define A_MAC_HSS3_PLLO_SSC_CFG1 0x3d630
#define A_MAC_HSS3_PLLO_SSC_CFG2 0x3d634
#define A_MAC_HSS3_PLLO_SSC_CFG3 0x3d638
#define A_MAC_HSS3_PLL1_DIV_CFG2 0x3d65c
#define A_MAC_HSS3_PLL1_DIV_CFG3 0x3d660
#define A_MAC_HSS3_PLL1_SSC_CFG0 0x3d664
#define A_MAC_HSS3_PLL1_SSC_CFG1 0x3d668
#define A_MAC_HSS3_PLL1_SSC_CFG2 0x3d66c
#define A_MAC_HSS3_PLL1_SSC_CFG3 0x3d670
#define A_MAC_HSS3_AN_CFG2 0x3d73c
#define A_MAC_HSS3_CTRL_FSM_CFG35 0x3d7cc
#define A_MAC_HSS3_CTRL_FSM_CFG36 0x3d7d0
...
#define A_ARM_UART_INT_CAUSE 0x47158

#define S_RX_FIFO_NOT_EMPTY 1
#define V_RX_FIFO_NOT_EMPTY(x) ((x) << S_RX_FIFO_NOT_EMPTY)
#define F_RX_FIFO_NOT_EMPTY V_RX_FIFO_NOT_EMPTY(1)

#define A_ARM_UART_INT_EN 0x4715c
...
#define S_SRAM2_WRITE_DATA2    0
#define M_SRAM2_WRITE_DATA2    0x1fffffffU
#define V_SRAM2_WRITE_DATA2(x) ((x) << S_SRAM2_WRITE_DATA2)
#define G_SRAM2_WRITE_DATA2(x) (((x) >> S_SRAM2_WRITE_DATA2) & M_SRAM2_WRITE_DATA2)
...
#define S_BIST_ADDR_FIFO_PARERR_CAUSE    3
...
#define S_BIST_ERR_ADDR_FIFO_PARERR_CAUSE    2
...
#define S_DDRCTL_ECC_UC_ERR_INTR_DCH1_CAUSE    2
#define V_DDRCTL_ECC_UC_ERR_INTR_DCH1_CAUSE(x) ((x) << S_DDRCTL_ECC_UC_ERR_INTR_DCH1_CAUSE)
#define F_DDRCTL_ECC_UC_ERR_INTR_DCH1_CAUSE    V_DDRCTL_ECC_UC_ERR_INTR_DCH1_CAUSE(1U)

#define S_DDRCTL_ECC_UC_ERR_INTR_DCH0_CAUSE    1
#define V_DDRCTL_ECC_UC_ERR_INTR_DCH0_CAUSE(x) ((x) << S_DDRCTL_ECC_UC_ERR_INTR_DCH0_CAUSE)
#define F_DDRCTL_ECC_UC_ERR_INTR_DCH0_CAUSE    V_DDRCTL_ECC_UC_ERR_INTR_DCH0_CAUSE(1U)
