...
struct ulp_invalidate {
	WR_HDR;
	__be32 op_to_cqid;
	__be32 tid_len16;
	__be32 reqsrc_to_pdid;
	__be32 cmdmore_qpid;
	__be32 wrid_pkd;
	__be32 stag;
};

#define S_ULP_INVALIDATE_OPCODE		24
#define V_ULP_INVALIDATE_OPCODE(x)	((x) << S_ULP_INVALIDATE_OPCODE)

#define S_T7_ULP_INVALIDATE_CHANNELID	 22
#define V_T7_ULP_INVALIDATE_CHANNELID(x) ((x) << S_T7_ULP_INVALIDATE_CHANNELID)

#define S_ULP_INVALIDATE_ERR2UP		19
#define V_ULP_INVALIDATE_ERR2UP(x)	((x) << S_ULP_INVALIDATE_ERR2UP)

#define S_ULP_INVALIDATE_SIGNLDBIT	16
#define V_ULP_INVALIDATE_SIGNLDBIT(x)	((x) << S_ULP_INVALIDATE_SIGNLDBIT)

#define S_ULP_INVALIDATE_CQID		0
#define V_ULP_INVALIDATE_CQID(x)	((x) << S_ULP_INVALIDATE_CQID)

#define S_ULP_INVALIDATE_TID		8
#define V_ULP_INVALIDATE_TID(x)		((x) << S_ULP_INVALIDATE_TID)

#define S_ULP_INVALIDATE_LEN16		0
#define V_ULP_INVALIDATE_LEN16(x)	((x) << S_ULP_INVALIDATE_LEN16)

#define S_ULP_INVALIDATE_REQSRC		31
#define V_ULP_INVALIDATE_REQSRC(x)	((x) << S_ULP_INVALIDATE_REQSRC)

#define S_ULP_INVALIDATE_CQ_WR_TYPE	23
#define V_ULP_INVALIDATE_CQ_WR_TYPE(x)	((x) << S_ULP_INVALIDATE_CQ_WR_TYPE)

#define S_ULP_INVALIDATE_PDID		0
#define V_ULP_INVALIDATE_PDID(x)	((x) << S_ULP_INVALIDATE_PDID)

#define S_ULP_INVALIDATE_CMDMORE	31
#define V_ULP_INVALIDATE_CMDMORE(x)	((x) << S_ULP_INVALIDATE_CMDMORE)

#define S_ULP_INVALIDATE_QPID		0
#define V_ULP_INVALIDATE_QPID(x)	((x) << S_ULP_INVALIDATE_QPID)

#define S_ULP_INVALIDATE_WRID		0
#define V_ULP_INVALIDATE_WRID(x)	((x) << S_ULP_INVALIDATE_WRID)
